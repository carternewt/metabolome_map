...
if __name__ == "__main__":
    ...
    df_fva_filtered.to_csv("/work/lylab/cjn40747/metabolome/{base}_filtered_GG.csv")
    df.to_csv("/work/lylab/cjn40747/metabolome/{base}_GG.csv")
    ...
    df_fba_filtered.to_csv("/work/lylab/cjn40747/metabolome/{base}_filtered_GG.csv")
    df_fba.to_csv("/work/lylab/cjn40747/metabolome/{base}_GG.csv")
